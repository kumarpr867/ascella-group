    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          onClick={scrollToTop}
        className="fixed bottom-8 right-8 z-50 w-12 h-12 flex items-center justify-center bg-black border border-white/20 rounded-full shadow-lg hover:bg-white transition-all duration-300 group"
...
>
  ...
  >
    <path
      ...
      stroke="white" /* Normal color white */
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
      className="transition-colors duration-300 group-hover:stroke-black" /* Hover color black */
    />
  </svg>
