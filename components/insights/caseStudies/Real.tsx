...
export default function Real() {
  return (
    <section className='border-y border-color'>
        <Reveal variants={slideInFromBottom(0.1)} className="relative max-w-7xl xl:mx-auto md:mx-10 md:border-x border-color h-[30vh] md:h-[50vh] flex items-end justify-center">
