  ...
  return (
    <section className='border-y border-color'>
        <div className="relative max-w-7xl xl:mx-auto mx-10 md:border-x border-color h-[40vh] md:h-[50vh] flex items-end justify-center">
            ...
            <h2 className='text-[20px] md:text-[36px] lg:text-[48px]'>Real Results. Real Impact.</h2>
            <p className='text-[12px] md:text-center md:text-[14px] max-w-2/3'>Explore how Ascella’s cybersecurity solutions deliver measurable business outcomes.</p>
            </div>
