export const content = [
  ...
  },
  {
    ...
    number: "05",
    title: "Ascella Forge",
    description: "Ascella Forge supports structured creation of internal tools, platforms, and operational assets. Work moves from idea to deployment with defined ownership and acceptance criteria. Engineering stays grounded in operational reality and long term use. Assets hold value because execution remains disciplined.",
    subDescription: "Process optimization, R&D, and technology adoption for business growth.",
    outcome: "Sustained innovation and competitive advantage.",
