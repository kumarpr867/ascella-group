    ...
    return (
        <section className="mt-20 border-y border-color">
            <div className="flex flex-col gap-10 py-10 lg:py-25">
                <div className="mx-10 lg:mx-20 xl:mx-24 px-10 xl:px-0 flex flex-col md:flex-row justify-between gap-5 ">
                ...
                <Reveal variants={slideInFromBottom(0.1)}  className="mx-10 lg:mx-20 xl:mx-24 border border-color flex-col items-center justify-center gap-10 xl:px-10 py-10">
                    <h4 className="text-[16px] md:text-[24px] text-center">Ascella Group holds operating authority</h4>

                    {/* Image */}
                    <div className="hidden lg:block relative w-full h-52 my-10">
                        <Image
                    ...
                    <div className="lg:hidden block relative w-full h-[500px] my-6">
                        <Image
                    ...
                    {/* Bottom Text */}
                    <h4 className="text-[16px] md:text-[24px] text-center">Execution arms deliver outcomes</h4>
                </Reveal>
            </div>
        </section>
    )
