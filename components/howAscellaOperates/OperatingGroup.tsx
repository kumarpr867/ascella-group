    ...
    return (
        <section className="mt-20 border-y border-color">
            <div className="flex flex-col gap-10 py-10 lg:py-25">
                ...
                <Reveal variants={slideInFromBottom(0.1)}  className="mx-10 xl:mx-auto xl:w-full max-w-7xl border border-color flex-col items-center justify-center gap-10 xl:px-10 py-10">
