    ...
    <section className="mx-auto max-w-7xl px-4">
      <div className="relative min-h-screen overflow-hidden">
        ...
        <div className="bg-gray-500 flex ">
          <div className="hidden lg:flex flex-col w-3xl gap-10 items-center">
            <div className="w-[500px] h-[500px] ">
              <ParticleGlobeScene />
            </div>
            <div className="flex flex-col flex-start pr-64 pl-20 pb-20">
          ...
          <div className="flex flex-col justify-between gap-5 p-10 lg:pr-15 py-10 lg:max-w-1/2">
            <div>
